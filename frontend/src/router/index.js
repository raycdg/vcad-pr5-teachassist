...
const routes = [
  ...
  { path: '/disciplines/:id/teachers', name: 'discipline-teachers', component: () => import('../views/DisciplineTeachers.vue'), meta: { requiresManager: true } },
  { path: '/courses', name: 'courses', component: Courses },
  { path: '/courses/:id/teachers', name: 'course-teachers', component: () => import('../views/CourseTeachers.vue'), meta: { requiresManager: true } },
